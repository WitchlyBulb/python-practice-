...
alerts_scores_for_all_patients = {}
...
for pt in patients:
    ...
    alerts_scores_for_all_patients[name] = alerts_score

max_alert_pt = max(alerts_scores_for_all_patients, key=lambda p: alerts_scores_for_all_patients[p])
print(f" --- Highest alert for patient: ---")
print(f"{max_alert_pt}: {alerts_scores_for_all_patients[max_alert_pt]} alerts")
